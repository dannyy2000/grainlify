...
function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Browse through curated projects or get matched with opportunities that fit you.',
    },
    {
      number: '03',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className={`backdrop-blur-[40px] border rounded-[24px] p-8 transition-all hover:border-[#c9983a]/30 hover:shadow-[0_12px_36px_rgba(201,152,58,0.15)] ${
                theme === 'dark'
                  ? 'bg-white/[0.08] border-white/15 hover:bg-white/[0.12]'
                  : 'bg-white/[0.15] border-white/25 hover:bg-white/[0.2]'
              }`}>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className={`backdrop-blur-[40px] border rounded-[28px] p-8 relative overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.08)] ${
              theme === 'dark'
  ...
  const testimonials = [
    {
      ...
      content: 'Grainlify helped me find amazing projects that align with my interests. The grant system is transparent and fair!',
      rating: 5,
    },
    {
      name: 'Marcus Johnson',
      ...
      avatar: 'https://images.unsplash.com/photo-1655249481446-25d575f1c054?w=400',
      content: 'As a maintainer, this platform has been incredible for finding talented contributors. Highly recommend!',
      rating: 5,
    },
    {
      ...
      avatar: 'https://images.unsplash.com/photo-1655249481446-25d575f1c054?w=400',
      content: 'The community here is amazing. I\'ve learned so much and made great connections through Grainlify.',
      rating: 5,
    },
  ];
  ...
  return (
    <footer className="relative py-16 px-6 border-t border-white/20">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="#features" className={`block transition-colors hover:text-[#c9983a] ${
                theme === 'dark' ? 'text-[#b8a898]' : 'text-[#7a6b5a]'
              }`}>Features</a>
              <a href="#how-it-works" className={`block transition-colors hover:text-[#c9983a] ${
                theme === 'dark' ? 'text-[#b8a898]' : 'text-[#7a6b5a]'
              }`}>How it Works</a>
              <a href="#" className={`block transition-colors hover:text-[#c9983a] ${
                theme === 'dark' ? 'text-[#b8a898]' : 'text-[#7a6b5a]'
              }`}>Pricing</a>
            </div>
          </div>
        ...
        {/* Bottom */}
        <div className={`pt-8 border-t border-white/20 text-center transition-colors ${
          theme === 'dark' ? 'text-[#b8a898]' : 'text-[#7a6b5a]'
        }`}>
